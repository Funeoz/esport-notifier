...
class Scoreboard:
    ...
    def score(self):
        """
        Return the score for each team as a dictionary where the team name
        is the key and their score is the value. This is just a convenience
        method to be able to rint the score quickly.
        """
        return {
    ...
    def leader(self):
        ...
        the current leading team. If the score is equal None will be returned
        """
